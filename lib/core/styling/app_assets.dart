class AppAssets {
  ...
  // Mood illustrations ship as PNG with a transparent background (the
  // original SVGs/PNGs baked "transparent" in as an opaque checkerboard).
  ...
  static const String lottieBlossom      = 'assets/lottie/blossom.json';
