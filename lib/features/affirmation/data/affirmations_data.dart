const Map<String, List<String>> affirmations = {
  ...
  '😢': [
    ...
    'Let the feeling have a little space. You can take the next moment slowly.',
    'You do not need to rush yourself through a difficult day.',
    'Be as kind to yourself as you would be to someone you care about.',
  ],
  '😰': [
    'You can pause here. One quiet moment is enough for now.',
    'Take a slow breath and notice what is around you.',
    'You do not have to solve everything right now. One small step is enough.',
    'Let your thoughts pass without needing to answer every one of them.',
  ],
  '😩': [
    'You have been carrying a lot. It is okay to take a quiet pause.',
    'It is okay to take your time. There is no need to rush this moment.',
    'A small break can be a kind choice for yourself.',
    'Rest is not laziness. You do not have to earn a pause.',
  ],
  '😭': [
    'Sometimes we need to fall apart to rebuild ourselves stronger.',
    'What you feel matters. You can write as much or as little as you want.',
    'You can use this space whenever writing things down feels helpful 💙',
