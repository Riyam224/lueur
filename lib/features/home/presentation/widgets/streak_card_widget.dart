...
class StreakCardWidget extends StatelessWidget {
  ...
  static String _motivationalMessage(BuildContext context, int streakDays) {
    final l10n = AppLocalizations.of(context)!;
    if (streakDays <= 0) return l10n.homeStreakMotivationStart;
    final next = StreakMilestone.next(streakDays);
    if (next != null && next.days - streakDays == 1) {
      return l10n.homeStreakMotivationMilestone;
    }
    return l10n.homeStreakMotivationActive;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      container: true,
      label: AppLocalizations.of(context)!.journalDayStreakLabel(streakDays),
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: AppSpacing.spaceMd),
            Text(
              _motivationalMessage(context, streakDays),
